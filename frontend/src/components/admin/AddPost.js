...
const AddPost = () => {
    ...
    const createPost = (event) => {
      ...
      navigate('/admin/addpost/researchdetails', {
        state: {
          post,
          image,
          uploadedImageName,
            ...
            <div className="my-3">
              ...
              <Editor
                ...
                init={{
                    ...
                    toolbar: 'anchor | undo redo | blocks fontfamily fontsize | bold italic underline strikethrough | link image media table mergetags | addcomment showcomments | spellcheckdialog a11ycheck typography | align lineheight | checklist numlist bullist indent outdent | emoticons charmap | removeformat',
                    anchor_top: false,
                    anchor_bottom: false, 
